...
def encode_question(question):
    ...
    #index using reverse_word_index

    reverse_word_index = pickle.load(open(DATA_DIR + 'reverse_word_index','rb'), protocol=pickle.HIGHEST_PROTOCOL)
    word_index = dict()
    ...
    question_seq = to_sequences(question,tokenizer)
    return question_seq
